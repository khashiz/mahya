...
<div class="readmore">
    ...
    <?php elseif ($params->get('show_readmore_title', 0) == 0) : ?>
        <a class="uk-button uk-button-accent uk-border-rounded uk-box-shadow-small font f500" href="<?php echo $displayData['link']; ?>" aria-label="<?php echo Text::sprintf('JGLOBAL_READ_MORE_TITLE', $this->escape($item->title)); ?>"><span><?php echo Text::_('READ'); ?></span></a>
    <?php else : ?>
