...
<div class="readmore">
    ...
    <?php elseif ($params->get('show_readmore_title', 0) == 0) : ?>
        <a class="font locationButton uk-border-pill uk-box-shadow-hover-medium uk-box-shadow-small uk-button uk-button-default uk-margin-auto uk-width-2-3" href="<?php echo $displayData['link']; ?>" aria-label="<?php echo Text::sprintf('JGLOBAL_READ_MORE_TITLE', $this->escape($item->title)); ?>">
            <i class="far fa-chevron-circle-left"></i>
            <span><?php echo Text::_('JGLOBAL_READ_MORE'); ?></span>
        </a>
    <?php else : ?>
