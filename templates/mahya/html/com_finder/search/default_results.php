...
<?php if (($this->suggested && $this->params->get('show_suggested_query', 1)) || ($this->explained && $this->params->get('show_explained_query', 1))) : ?>
    <div id="search-query-explained" class="uk-hidden com-finder__explained">
...
<?php if (($this->total === 0) || ($this->total === null)) : ?>
    <div id="search-result-empty" class="com-finder__empty uk-text-center">
        <h2 class="uk-h4 font uk-text-danger f700"><?php echo Text::_('COM_FINDER_SEARCH_NO_RESULTS_HEADING'); ?></h2>
        <?php $multilang = Factory::getApplication()->getLanguageFilter() ? '_MULTILANG' : ''; ?>
        <p class="uk-text-muted font"><?php echo Text::sprintf('COM_FINDER_SEARCH_NO_RESULTS_BODY' . $multilang, $this->escape($this->query->input)); ?></p>
    </div>
...
<ol id="search-result-list" class="js-highlight com-finder__results-list uk-child-width-1-1" data-uk-grid start="<?php echo (int) $this->pagination->limitstart + 1; ?>">
