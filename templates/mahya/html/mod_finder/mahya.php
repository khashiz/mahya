...
?>
<div class="uk-width-1-1 uk-width-auto@s uk-flex uk-flex-middle searchWrapper" id="searchWrapper">
    <form class="uk-width-1-1 uk-box-shadow-small mod-finder js-finder-searchform form-search uk-border-pill uk-flex uk-flex-middle" action="<?php echo Route::_($route); ?>" method="get" role="search">
        <div>
            <div class="uk-grid-small uk-grid-divider" data-uk-grid>
                <div class="uk-flex uk-flex-middle uk-text-primary"><i class="fas fa-search"></i></div>
                <div>
			        <?php echo $output; ?>
